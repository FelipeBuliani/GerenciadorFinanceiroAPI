...
namespace GerenciadorFinanceiroAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ReceitasService>();
            services.AddScoped<DespesasService>();

            services.AddCors();

            services.AddSpaStaticFiles(diretorio => {
                diretorio.RootPath = "GerenciadorFinanceiroUI";
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSpa(spa =>
            {
                spa.Options.SourcePath = Path.Combine(Directory.GetCurrentDirectory(), "GerenciadorFinanceiroUI");
